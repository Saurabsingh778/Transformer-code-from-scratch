...
class LayerNormalization_:
    def __init__(self, no_of_nodes = 512, batch_size = 32, gamma = 1, beta = 0, attention_vector = None, pos_vector = None):
        input = add(attention_vector, pos_vector)
