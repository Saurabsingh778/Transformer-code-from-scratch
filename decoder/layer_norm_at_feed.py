...
class LayerNormalization_3:
    def __init__(self, no_of_nodes = 512, batch_size = 32, gamma = 1, beta = 1, pos = 0, feed_vector = None, norm_vector = None):
        input = add(feed_vector, norm_vector).get_output()
