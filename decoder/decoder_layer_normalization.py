...
class LayerNormalization_1:
    def __init__(self, no_of_nodes = 512, batch_size = 32, gamma = 1, beta = 1, pos = 0, position_vector = None, mask_vector = None):
        input = add(position_vector, mask_vector).get_output()
