...
class LayerNormalization_2:
    def __init__(self, no_of_nodes = 512, batch_size = 32, gamma = 1, beta = 1, pos = 0, norm_vector = None, cross_vector = None):
        input = add(norm_vector, cross_vector).get_output()
